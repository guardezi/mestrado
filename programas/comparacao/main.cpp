...
void help(){
    cout <<"op:\n0 - extrair caracteristicas\n1 - carregar"<<endl;
    cout <<"Detectores: IORB, ORB, SURF, SIFT"<<endl;
    cout <<"Descritores: ORB, SURF, SIFT"<<endl;
    cout <<"./topologico [op] [Detector] [Descriptor] <arquivo"<< endl;
}

int main(int argc, char *argv[]){

    double inicial = (double) getTickCount();
    ...
    int op = atoi(argv[1]);
    string detect=argv[2];
    string describ=argv[3];
    string filename = "base/"+detect+"_"+describ+".yml";
